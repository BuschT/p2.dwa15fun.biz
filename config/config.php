...
# What is the name of this app?
	define('APP_NAME', 'My Microblog');

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'webmaster@dwafun15.biz');
...
*/
	define('SYSTEM_EMAIL', 'Taylorbusch@gmail.com');

# Default DB name for this app
	define('DB_NAME', 'dwafunbi_p2_dwa15fun_biz');
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'Dv0kU8_JSHbOZk@6k^YnH^WQ@EO%WE%b2WkWrj$_');
	define('TOKEN_SALT', '8dtHnKliRZf%LEAf(Fu$y%X70O0R$rK25nqm5IVt');